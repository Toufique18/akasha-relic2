...
function TableFooter({ className, ...props }: React.ComponentProps<"tfoot">) {
  return (
    <tfoot
      ...
      className={cn(
        "bg-gray-100 dark:bg-gray-800 border-t dark:border-gray-700 font-medium",
        className
      )}
      {...props}
    />
...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "h-10 px-2 text-left font-medium text-gray-700 dark:text-gray-300 whitespace-nowrap",
        className
      )}
      {...props}
    />
...
function TableCell({ className, ...props }: React.ComponentProps<"td">) {
  return (
    <td
      ...
      className={cn(
        "p-2 align-middle text-gray-800 dark:text-gray-200 whitespace-nowrap",
        className
      )}
      {...props}
    />
